...
public class HorizontalMedMoviesAdapter extends PagedListAdapter<FilmixMovie, HorizontalMedMoviesAdapter.MovieHolder> {

    private HorizontalAdapterListener listener;

    public class MovieHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.movie_title_upd_med_tv)
        TextView titleTextView;
        @BindView(R.id.movie_duration_upd_med_tv)
        TextView durationTextView;
        @BindView(R.id.movie_year_upd_med_tv)
        TextView yearTextView;
        @BindView(R.id.pos_rating_value_upd_med)
        TextView posTextView;
        @BindView(R.id.neg_rating_value_upd_med)
        TextView negTextView;
        @BindView(R.id.blured_poster_upd_med_image_view)
        ImageView bluredPosterImageView;
        @BindView(R.id.poster_upd_med_image_view)
    ...
    public HorizontalMedMoviesAdapter(HorizontalAdapterListener listener) {
        super(DIFF_CALLBACK);
...
//                    return oldItem.getId() == (newItem.getId());
    ...
    public MovieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movie_upd_med, parent, false);
        return new HorizontalMedMoviesAdapter.MovieHolder(itemView);
    }
